...
class DownloadQueue(ctk.CTkFrame):
    ...
    def update(self, stats):
        ...
        #
        # NOTE:
        # rclone RC currently doesn't expose upload/download direction.
        # This is future-ready. When download support is added,
        # pass direction="download" from transfer_manager.
        #
